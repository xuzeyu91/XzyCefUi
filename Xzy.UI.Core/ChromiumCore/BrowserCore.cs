	...
	: this(parentContainer, null, true)
		...
		internal void OnBrowserCreated(CfxOnAfterCreatedEventArgs e)
		{
			...
			OnV8ContextCreated += (that, args) =>
			{
				...
				{
#if XP
					args.Frame.ExecuteJavaScript(Xzy.UI.Core.XP.Properties.Resources.nanui_frameGlobal, null, 0);
#else
					args.Frame.ExecuteJavaScript(Xzy.UI.Core.Properties.Resources.nanui_frameGlobal, null, 0);
#endif
				}
			};
