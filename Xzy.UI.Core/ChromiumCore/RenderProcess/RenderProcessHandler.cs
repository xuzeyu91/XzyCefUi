...
#if XP
			CfrRuntime.RegisterExtension("nanui/base", Xzy.UI.Core.XP.Properties.Resources.nanui_nativeExtension, handler);
#else
			CfrRuntime.RegisterExtension("nanui/base", Xzy.UI.Core.Properties.Resources.nanui_nativeExtension, handler);
#endif
